...
For the reviewed npm release, run the exact version:
...
The package manifest also exposes the `ai-crawler-robots` executable for a reviewed local installation:
